        ...
        this.init = function()
        {
            ...
            __indicators = 
            {
                'assets':
                {
                    ...
                    'legend'  : "<?php echo mb_convert_encoding(_('Assets'), 'UTF-8', 'HTML-ENTITIES') ?>"
                },
                'vulnerabilities':
                {
                    'load'    : __self.load_vulnerabilities,
                    'provider': 'get_status_vulnerabilities.php',
                    'legend'  : "<?php echo mb_convert_encoding(_('Vulnerabilities'), 'UTF-8', 'HTML-ENTITIES') ?>"
                },
                'alarms':
                {
                    'load'    : __self.load_alarms,
                    'provider': 'get_status_alarms.php',
                    'legend'  : "<?php echo mb_convert_encoding(_('Alarms'), 'UTF-8', 'HTML-ENTITIES') ?>"
                },
                'events':
                {
                    'load'    : __self.load_events,
                    'provider': 'get_status_events.php',
                    'legend'  : "<?php echo mb_convert_encoding(_('Events'), 'UTF-8', 'HTML-ENTITIES') ?>"
                },
                'services':
                {
                    'load'    : __self.load_services,
                    'provider': 'get_status_services.php',
                    'legend'  : "<?php echo mb_convert_encoding(_('Services'), 'UTF-8', 'HTML-ENTITIES') ?>"
                },
                'availability':
                {
                    'load'    : __self.load_availability,
                    'provider': 'get_status_availability.php',
                    'legend'  : "<?php echo mb_convert_encoding(_('Availability'), 'UTF-8', 'HTML-ENTITIES') ?>"
                },
                ...
                'notes':
                {
                    ...
                    'legend'  : "<?php echo mb_convert_encoding(_('Notes'), 'UTF-8', 'HTML-ENTITIES') ?>"
                },
                'groups':
                {
                    'load'    : __self.load_groups,
                    'provider': 'get_status_groups.php',
                    'legend'  : "<?php echo mb_convert_encoding(_('Groups'), 'UTF-8', 'HTML-ENTITIES') ?>"
                }  
            };
